...
$result = mysqli_query($conn,"SELECT * FROM myansong ORDER BY id ASC");
...
<br>
<div class="container">
  <h2>⭐️Favourite Myanmar Song⭐️</h2>
  <form action="add.php">
  ...
  <table class="table table-dark table-hover">
      ...
      <?php
           while($res = mysqli_fetch_array($result)){
               ...
               echo "<td><a href=\"query/edit.php?id=$res[id]\">Edit</a>|<a href=\"query/delete.php?id=$res[id]\" onclick=\"return confirm('Are you sure want to delete?')\">DELETE</a></td>";
               echo "</tr>";
           }
           ?>
      </tr>
