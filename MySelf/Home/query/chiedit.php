...
$id= $_GET['id'];
$result = mysqli_query($conn,"SELECT * FROM chisong ORDER BY id=$id");
...
<div class="container mt-3">
  <h3>Please Edit New Chienes Song </h3>
  <br><br>
  <form action="chiupdate.php" method="POST">
    <div class="inputt-group mb-3">
      <div class="inpu-group-prepend">
        <span class="input-group-text"> ⭐️Chienes Song⭐️ </span>
      </div>
