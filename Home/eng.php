...
$result = mysqli_query($conn,"SELECT * FROM engsong ORDER BY id ASC");
...
<div class="container">
  <h2>⭐️Favourite English Song⭐️</h2>
  <form action="addeng.php">
    ...
    <tr>
      ...
      <?php
           while($res = mysqli_fetch_array($result)){
               ...
               echo "<td><a href=\"query/engedit.php?id=$res[id]\">Edit</a>|<a href=\"query/engdelete.php?id=$res[id]\" onclick=\"return confirm('Are you sure want to delete?')\">DELETE</a></td>";
               echo "</tr>";
           }
           ?>
      </tr>
