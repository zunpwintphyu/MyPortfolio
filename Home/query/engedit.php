...
$id= $_GET['id'];
$result = mysqli_query($conn,"SELECT * FROM engsong ORDER BY id=$id");
...
<div class="container mt-3">
  <h3>Please Edit New English Song </h3>
  <br><br>
  <form action="engupdate.php" method="POST">
    <div class="input-group mb-3">
      <div class="input-group-prepend">
        <span class="input-group-text"> ⭐️English Song⭐️ </span>
      </div>
